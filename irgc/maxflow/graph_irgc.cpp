...
template <typename captype, typename tcaptype, typename flowtype> 
	GraphIrgc<captype, tcaptype, flowtype>::GraphIrgc(long node_num_max, long edge_num_max, void (*err_function)(char *))
	: node_num(0),
	  nodeptr_block(NULL),
...
template <typename captype, typename tcaptype, typename flowtype> 
	GraphIrgc<captype,tcaptype,flowtype>::~GraphIrgc()
{
	if (nodeptr_block) 
	{ 
...
template <typename captype, typename tcaptype, typename flowtype> 
	void GraphIrgc<captype,tcaptype,flowtype>::reset()
{
	node_last = nodes;
	arc_last = arcs;
	node_num = 0;
...
template <typename captype, typename tcaptype, typename flowtype> 
	void GraphIrgc<captype,tcaptype,flowtype>::reallocate_nodes(int num)
{
...
// won't work
template <typename captype, typename tcaptype, typename flowtype> 
	void GraphIrgc<captype,tcaptype,flowtype>::reallocate_arcs()
{
