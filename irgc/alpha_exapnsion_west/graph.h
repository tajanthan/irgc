...
public:
	...
	Graph(long node_num_max, long edge_num_max, void (*err_function)(const char *) = NULL);
...
template <typename captype, typename tcaptype, typename flowtype> 
	inline typename Graph<captype,tcaptype,flowtype>::node_id Graph<captype,tcaptype,flowtype>::add_node(long num)
{
	assert(num > 0);
